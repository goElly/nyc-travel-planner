...
import sp.senior.wd.dummy.DummyContent;

public class MySchedules extends AppCompatActivity implements SingleSchedule.OnListFragmentInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent();
                i.setClass(MySchedules.this, MapsActivity2.class);
                startActivity(i);
            }
        });
        ...
        fab2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                i2.setClass(MySchedules.this, SQLTestActivity.class);
                startActivity(i2);
            }
        });
